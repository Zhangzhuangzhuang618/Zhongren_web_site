 ...
 *
 * Usage: php scripts/import_legacy_dump.php /absolute/path/to/zhongren_com.sql
 */

$dumpPath = $argv[1] ?? '';
if ($dumpPath === '' || !is_file($dumpPath)) {
    fwrite(STDERR, "Usage: php scripts/import_legacy_dump.php /path/to/zhongren_com.sql\n");
    exit(1);
}
