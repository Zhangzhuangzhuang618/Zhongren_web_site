...
abstract class BaseController
{
    ...
    protected function render(string $view, array $data = []): void
    {
        ...
        $pageSchema = [
            ...
            '@type' => 'WebPage',
            'name' => $data['page_title'] ?? $this->siteConfig['company_name'] ?? '广东众人搬家起重吊装有限公司',
    ...
    protected function getCommonData(): array
    {
        ...
        return [
            'site' => [
                ...
                'logo'        => $config['web_logo'] ?? $config['web_logo_image'] ?? '/upload/brand/zhongren-logo-red-transparent.png',
                'ico'         => $config['site_ico'] ?? '/upload/brand/zhongren-logo-red-transparent.png',
    ...
    {
        return $title . '_广州天河搬家公司_工厂搬家_仓库搬家_日式搬家-广州众人搬家';
    }
    ...
    {
        $this->initConfig();
        $domain = trim((string)($this->siteConfig['web_domain'] ?? 'www.zrbanjia.com'));
