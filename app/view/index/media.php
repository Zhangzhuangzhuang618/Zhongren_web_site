...
<div class="page-banner"><img src="<?= htmlspecialchars($assetUrl($banner ?? ''), ENT_QUOTES, 'UTF-8') ?>" class="w100 block" alt="媒体报道"></div>
