...
Base URL：`/api/geo/v1`。GEO Content OS 平台账号应填写包含该路径前缀的完整 HTTPS 地址，例如 `https://www.zrbanjia.com/api/geo/v1/`。
...
```json
{
  ...
  "size_bytes": 123456,
  "url": "https://www.zrbanjia.com/upload/geo/ab/完整哈希.jpg"
}
```
...
```json
{
  "external_id": "123",
  "status": "published",
  "url": "https://www.zrbanjia.com/detail/news123.html",
