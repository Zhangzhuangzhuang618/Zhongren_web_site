...
// 系统配置
$configs = [
    ['company_name', '广东众人搬家起重吊装有限公司', 'web', 'site'],
    ['web_phone', '18148943200', 'web', 'site'],
    ['web_call', '18148943200', 'web', 'site'],
    ['web_email', 'service@zrbanjia.com', 'web', 'site'],
    ['web_address', '广州市天河区棠东东路7号智域空间101室', 'web', 'site'],
    ['site_copyright', 'Copyright © 2025 广东众人搬家起重吊装有限公司 版权所有', 'web', 'site'],
    ['site_beian', '粤ICP备2025366021号', 'web', 'site'],
    ['seo_title', '广州天河搬家公司_工厂搬家_仓库搬家_日式搬家-广州众人搬家', 'web', 'seo'],
    ['seo_keyword', '广州天河搬家公司,广州工厂搬家,广州机器设备吊装,广州仓库搬迁,广州学校搬迁,广州日式搬家', 'web', 'seo'],
    ['seo_content', '广东众人搬家公司【18148943200】主营业务:广州搬家公司,广州工厂搬家,单位搬家,办公室搬家,大型企业投标服务.', 'web', 'seo'],
    ...
    ['web_domain', 'https://www.zrbanjia.com', 'web', 'site'],
...
$stmt = $db->prepare("INSERT INTO zw_cms_product (title,sketch,nav_id,image,create_time) VALUES (?,?,?,'/upload/brand/zhongren-logo-red-transparent.png','2025-01-20')");
...
$stmt->execute(['banner1','/upload/20250216/b2b853613e76f9d5434b728944756da0.jpg',1]);
